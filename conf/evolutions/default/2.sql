...
insert into rsv(id,begin_rsv,end_rsv,contrib) values (1,'2012-01-01','2014-12-31',1);
insert into address(street,number,zip,city,ms_ref,rsv_ref) values ('Talweg','16','53229','Bonn',1,1);
insert into contact(phoneHome,phoneOffice,mobile,email,ms_ref) values ('030123456','0302232357','01761234123','huckebein@rabenhorst.de',1);
...
insert into contact(phoneHome,phoneOffice,mobile,email,ms_ref) values ('0228123456','02282232357','01519876543','mouse@entenhausen.de',2);
